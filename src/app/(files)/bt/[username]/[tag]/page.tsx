...
import SharedBookmarksTagClient from "@/components/Bookmarks/SharedBookmarksTagClient";
...
export async function generateMetadata({
  ...
  const title = `${decodeURIComponent(username)}'s ${decodedTag} bookmarks`;
  const description = `Public bookmarks tagged "${decodedTag}" on ${appName}.`;
...
export default async function PublicBookmarksByTagPage({
  params,
}: {
  params: Params;
}) {
